      ...
      <div class="md-modal-inner">
        ...
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error error-wrap" v-show="errorTip">用户名或密码错误</div>
            <ul>
          ...
          <div class="login-wrap"><a href="javascript:;" @click="login()" class="btn-login">登  录</a></div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    getCartCount() {
      axios.get('/users/getCartCount').then(result => {
        result = result.data;
        this.$store.commit('initCartCount', result.result);
      });
    }
  }
}
