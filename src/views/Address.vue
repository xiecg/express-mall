<template>
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                ...
                <li v-for="(item, index) in addressListFilter" :class="{check: checkIndex == index}" @click="setAddress(index, item.addressId)">
                  <dl>
                    <dt>{{ item.userName }}</dt>
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" @click="expand()" :class="{open: limit == addressList.length}">
                more
                <i class="i-up-down">
          ...
          <div class="next-btn-wrap">
            <a class="btn btn--m btn--red" :href="`/#/orderConfirm?addressId=${ addressId }`">Next</a>
          </div>
        </div>
      </div>
    </div>
    <modal :mdShow="modalConfirm" @close="closeModal">
      ...
      <div slot="btnGroup">
        <a href="javascript:void(0);" @click="delAddress()" class="btn btn--m">确认</a>
